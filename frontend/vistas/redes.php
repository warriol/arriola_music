...
<section id="s6">
    ...
    <div class="footer-video-frame">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/LNGkfFc0Fpk?si=pDiHQQkmT-xeRQot"
    ...
    <div class="bottom-wood-base">
        <div class="metal-plate">
            ...
            <div class="social-links">
                <a href="https://www.instagram.com/arriola_musica/" target="_blank" class="social-icon">
                ...
                <a href="https://www.youtube.com/@arriola_musica" target="_blank" class="social-icon">
                    <svg viewBox="0 0 24 24">
                        <path
                ...
                <a href="https://www.facebook.com/joselito11179" target="_blank" class="social-icon">
                    <svg viewBox="0 0 24 24">
                        <path
                ...
                <a href="https://open.spotify.com/artist/47CJG3RNzKaw1WI5lQ55eB" target="_blank" class="social-icon">
                    <svg viewBox="0 0 24 24">
                        <path
            ...
            <a href="https://linktr.ee/Jose_Arriola" target="_blank" class="linktree-btn">VISITAR LINKTREE
                OFICIAL</a>
        </div>
        <!-- Créditos grabados -->
