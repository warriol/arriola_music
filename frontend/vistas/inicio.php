<!-- SECCIÓN 01: INICIO (ID: s1) -->
<section id="s1">
    <div class="flex flex-col md:flex-row items-center gap-12 max-w-5xl px-6">
        ...
        <div class="bio-box">
            ...
            <p class="text-lg text-zinc-300 leading-relaxed">
                ...
                encuentran en este dial. Cantautor y compositor nacido en la ciudad de Buenos Aires.
            </p>
        </div>
    </div>
</section>